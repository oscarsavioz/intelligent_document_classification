from classes.load_models import HybridModel
...
if __name__ == "__main__":
    ...
    data_module.setup(mode="hybrid")

    model = HybridModel(num_classes=num_classes, learning_rate=args.learning_rate)

    # Use integrated Weights&Biases logger to log metadata, loss and accuracy
    wandb_logger = pl.loggers.WandbLogger(
        project="tb-experiments",
        config={
            "architecture": "Hybrid (RoBERTa + ResNet50)",
            "dataset": "RVL-CDIP",
            "epochs": args.epochs,
