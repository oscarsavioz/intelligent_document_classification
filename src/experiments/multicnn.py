from classes.load_models import MultiCNNModel
...
if __name__ == "__main__":
    ...
    model = MultiCNNModel(mobilenet_checkpoint_path="models/mobilenetv3_pretrained/mobilenetv3_best.ckpt",
                          resnet50_checkpoint_path="models/resnet50/resnet50_best.ckpt",
    ...
    callbacks = [pl.callbacks.ModelCheckpoint(
                            dirpath="models/multicnn",
                            filename="multicnn_best",
                            monitor="val_acc",
